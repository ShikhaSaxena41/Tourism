                ...
                <div class="col-lg-9">
                    <div class="search_wrap">
                        <form class="search_form" action="#">
                            ...
                            <div class="input_field">
                                <select>
                                    <option data-display="Travel type">Select</option>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="single_select">
                                            <select>
                                                ...
                                                <option data-display="Places">places</option>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="single_select">
                                            <select>
                                                ...
                                                <option value="2">Pilgrims</option>
                                                <option value="4">other</option>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="single_place">
                                ...
                                <div class="place_info">
                                    <a href="destination_details.jsp"><h3>Omkareshwar</h3></a>
                                    <p>Madhya Pradesh</p>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single_place">
                                ...
                                <div class="place_info">
                                    <a href="destination_details.jsp"><h3>Manali</h3></a>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single_place">
                                ...
                                <div class="place_info">
                                    <a href="destination_details.jsp"><h3>Sanchi stupa</h3></a>
                                    <p>Madhya Pradesh</p>
                                    <div class="rating_days d-flex justify-content-between">
                                        <span class="d-flex justify-content-center align-items-center">
                                             <i class="fa fa-star"></i> 
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single_place">
                                ...
                                <div class="place_info">
                                    <a href="destination_details.jsp"><h3>Panchmarhi</h3></a>
                                    <p>Madhya Pradesh</p>
                                    <div class="rating_days d-flex justify-content-between">
                                        <span class="d-flex justify-content-center align-items-center">
                                             <i class="fa fa-star"></i> 
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single_place">
                                ...
                                <div class="place_info">
                                    <a href="destination_details.jsp"><h3>Panjim</h3></a>
                                    <p>Goa</p>
                                    <div class="rating_days d-flex justify-content-between">
                                        <span class="d-flex justify-content-center align-items-center">
                                             <i class="fa fa-star"></i> 
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single_place">
                                ...
                                <div class="place_info">
                                    <a href="destination_details.jsp"><h3>Kutch</h3></a>
                                    <p>Gujarat</p>
                                    <div class="rating_days d-flex justify-content-between">
                                        <span class="d-flex justify-content-center align-items-center">
                                             <i class="fa fa-star"></i> 
                                ...
                                <div class="mail_form">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-lg-3 col-md-4">
                                            ...
                                            <a class="boxed-btn4 " href='contact.jsp'>Contact</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>
